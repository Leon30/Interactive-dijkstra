...
import views.balloontip.positioners.BalloonTipPositioner;
import views.balloontip.positioners.BasicBalloonTipPositioner;
import views.balloontip.positioners.LeftAbovePositioner;
import views.balloontip.positioners.LeftBelowPositioner;
import views.balloontip.positioners.RightAbovePositioner;
import views.balloontip.positioners.RightBelowPositioner;
import views.balloontip.styles.BalloonTipStyle;
...
public class BalloonTip extends JPanel {
	...
	private static Icon defaultCloseIcon  = new ImageIcon(BalloonTip.class.getResource("/views/balloontip/resources/close_default.png"));
	private static Icon rolloverCloseIcon = new ImageIcon(BalloonTip.class.getResource("/views/balloontip/resources/close_rollover.png"));
	private static Icon pressedCloseIcon  = new ImageIcon(BalloonTip.class.getResource("/views/balloontip/resources/close_pressed.png"));
